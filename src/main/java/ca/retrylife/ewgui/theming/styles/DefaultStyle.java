...
public class DefaultStyle extends Style {
    ...
    public ColorSet getFocused() {
        return new ColorSet(new Color(0x6c, 0x9b, 0xbc), new Color(0x6c, 0x9b, 0xbc), new Color(0xc9, 0xef, 0xfe));
    }

    @Override
    public ColorSet getPressed() {
        return new ColorSet(new Color(0x36, 0x8b, 0xaf), new Color(0x36, 0x8b, 0xaf), new Color(0x97, 0xe8, 0xff));
    }

    @Override
    public ColorSet getDisabled() {
        return new ColorSet(new Color(0xae, 0xb7, 0xb8), new Color(0xae, 0xb7, 0xb8), new Color(0xe6, 0xe9, 0xe9));
    }
